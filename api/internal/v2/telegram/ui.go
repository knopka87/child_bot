...
const (
	...
	HintProgress4           = "✨ Почти готово…"
	CheckProgress1          = "🤓 Вижу твоё решение!"
	CheckProgress2          = "🔍 Анализирую решение…"
	CheckProgress3          = "🧮 Проверяю шаги…"
	CheckProgress4          = "✨ Сверяю ответ…"
	...
	ParseExpiredText        = "⏰ Время ожидания истекло.\n📸 Отправь фото задания ещё раз — и продолжим! 🤓"
