-- Achievement examples for testing
...
-- Достижения за побеждённых монстров
INSERT INTO achievements (id, type, title, description, icon, requirement_type, requirement_value,
                          reward_type, reward_name, reward_amount, priority)
VALUES
...
-- Достижения за правильно решённые задачи
INSERT INTO achievements (id, type, title, description, icon, requirement_type, requirement_value,
                          reward_type, reward_name, reward_amount, priority)
VALUES
...
-- Достижения за задачи без подсказок
INSERT INTO achievements (id, type, title, description, icon, requirement_type, requirement_value,
                          reward_type, reward_name, reward_amount, priority)
VALUES
...
-- Комментарии
COMMENT ON TABLE achievements IS 'Достижения: streak_days, villains_defeated, tasks_correct, tasks_no_hints, stickers_collected';
