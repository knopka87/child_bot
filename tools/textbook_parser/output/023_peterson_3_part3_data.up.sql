...
VALUES ('matematika', 3, 'Петерсон Л.Г.', 'Математика 3 класс', 3, 2022, 'Просвещение', 'https://gdz-raketa.ru/matematika/3-klass/peterson-uchebnik')
...
DECLARE
    ...
    v_task_id BIGINT;
BEGIN
    SELECT id INTO v_textbook_id FROM textbooks WHERE subject = 'matematika' AND grade = 3 AND authors = 'Петерсон Л.Г.' AND part = 3;
